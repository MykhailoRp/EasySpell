...
APPMOD: Final[LiteralString] = "easyspell.main:app"
...
@click.option(
    ...
    default="0.0.0.0",
    envvar="ES_HOST",
    help="Host to bind to (can be set with ES_HOST env variable)",
)
@click.option(
    "--port",
    default=8000,
    envvar="ES_PORT",
    help="Port to bind to (can be set with ES_PORT env variable)",
)
@click.option(
    "--reload/--no-reload",
    default=False,
    envvar="ES_RELOAD",
    help="Enable reload (can be set with ES_RELOAD env variable)",
)
